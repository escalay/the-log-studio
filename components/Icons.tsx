...
export const WaterWheelIcon = ({ className }: { className?: string }) => (
...
export const NubianPattern = ({ className }: { className?: string }) => (
    <svg width="40" height="10" viewBox="0 0 40 10" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M0 10L5 0L10 10H0Z" fill="currentColor"/>
        <path d="M10 10L15 0L20 10H10Z" fill="currentColor"/>
        <path d="M20 10L25 0L30 10H20Z" fill="currentColor"/>
        <path d="M30 10L35 0L40 10H30Z" fill="currentColor"/>
    </svg>
);
